...
weights = {
            ...
            '2_w_conv8':variable(2,8,[3,3,6,128]),
            '2_w_conv9':variable(2,9,[3,3,128,256]),
            '4x_out':variable(2,10,[1,1,64,3]),
            ...
            '3_w_conv10':variable(3,10,[3,3,6,128]),
            '3_w_conv11':variable(3,11,[3,3,128,256]),
            '3_w_conv12':variable(3,12,[3,3,64,3]),
            '3_w_conv13':variable(3,13,[5,5,6,128]),
            '3_w_conv14':variable(3,14,[7,7,128,256]),
            '8x_out':variable(3,15,[1,1,64,3]),
...
biases = {
            ...
            '2_b_conv8':tf.Variable(tf.zeros([128])),
            '2_b_conv9':tf.Variable(tf.zeros([256])),
            '4x_out':tf.Variable(tf.zeros([3])),
            ...
            '3_b_conv10':tf.Variable(tf.zeros([128])),
            '3_b_conv11':tf.Variable(tf.zeros([256])),
            '3_b_conv12':tf.Variable(tf.zeros([3])),
            '3_b_conv13':tf.Variable(tf.zeros([128])),
            '3_b_conv14':tf.Variable(tf.zeros(256)),
            '8x_out':tf.Variable(tf.zeros(3)),
